    ...
    <div class="content add-user edit-user">
        ...
        <div class="row">
            <div class="col-md-7 m-auto">
                <form class="user-form" action="{{route('customers.store')}}" method="POST" enctype="multipart/form-data" >
                    @csrf
                            ...
                            <div class="form-box">
                                ...
                                <div class="row p-0 w-100 m-auto">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="email" name="email" id="input-password" class="form-control form-control-alternative{{ $errors->has('Email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" value="{{ old('email') }}" required autofocus>
                                        @if ($errors->has('email'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group{{ $errors->has('phone_number') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="phone_number" id="input-password" class="form-control form-control-alternative{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" placeholder="{{ __('phone_number') }}" value="{{ old('phone_number') }}" required autofocus>
