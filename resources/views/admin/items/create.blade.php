    ...
    <div class="content add-user edit-user">
        ...
        <div class="row">
            ...
            <div class="col-md-7 m-auto">
                <form class="user-form" action="{{route('items.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="form-box">
                                ...
                                <div class="row p-0 w-100 m-auto">
                                    ...
                                    <div class="m-b-10 col-sm-12 col-md-6 form-group">
                                        ...
                                        <select name="category_id"  class="form-control select2 select2-hide-search">
